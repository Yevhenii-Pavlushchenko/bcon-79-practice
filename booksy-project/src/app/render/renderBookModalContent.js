export function renderBookModalContent(bookData = {}, el) {
  ...
  <div class="book-modal-content">
    ...
    <img src="${bookData.book_image}" alt="${bookData.title}" width="${bookData.book_image_width}" height="${bookData.book_image_height}" />
  </div>
  <div class="book-modal-right">
    <h2 class="modal-title">${bookData.title}</h2>
